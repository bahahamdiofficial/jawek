...
<body class="body_back">
    ...
    <?php endif; ?>
            <div class="login-card">
                ...
                <form action="new_password.php" method="post" class="login-form">
                    <input type="text" name="code" id="code" placeholder="Entrez le code" value="<?= htmlspecialchars($_POST["email"] ?? "") ?>" required>
