...
function sendInfo()
{
    ...
    try {
        ...
        $mail->Host = '	mail.smallcarsdirect.co.uk';
        ...
        $mail->Username = 'dev@smallcarsdirect.co.uk';

        // ENTER CORRESPONDING ACCOUNT EMAIL
        $mail->Password = '(testingdev14419)';
        ...
        $mail->setFrom("dev@smallcarsdirect.co.uk", 'Sane assets');



        // THIS IS THE EMAIL THAT SHOULD RECIEVE THE MESSAGES. CAN EVEN BE YOUR GMAIL
        $mail->addAddress("xnduhiux@gmail.com", "New contact");
                   ...
                   <td class="container">
                       ...
                       <div class="content">
                           <table>
                                <tr>
                                    <td>
                                            <p>THis is just an email test</p>
                                    </td>
                                </tr>
                           </table>
                       </div>
