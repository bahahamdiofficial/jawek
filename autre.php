          ...
          <div class="left__col">
            <div class="list-category">
                ...
                <ul>
                    ...
                    <a href="Immobilier.php"><li>Immobilier</li></a>
                    ...
                    <a href="Mode.php"><li class="active-link">Mode</li></a>
                    <a href="Services.php"><li>Services</li></a>
                    <a href="jeux.php"><li>Jeux</li></a>
                    <a href="autre.php"><li class="active-link">Autre</li></a>
                </ul>
            </div>
            </di>
          </div>
