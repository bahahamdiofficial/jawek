...
<head>
    ...
    <title>Jawek.tn | Admin dashboard </title>
    ...
    <?php endif; ?>
            <div class="login-card">
                ...
                <form method="post" class="login-form">
                    <input type="text" name="email" id="email" placeholder="Adresse email professionnelle" value="<?= htmlspecialchars($_POST["email"] ?? "") ?>" required>
